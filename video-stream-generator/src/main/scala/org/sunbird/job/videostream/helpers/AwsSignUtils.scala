...
object AwsSignUtils {
	...
	def getSiginingkey()(implicit config: VideoStreamGeneratorConfig): Array[Byte] = {
	...
	def getStringToSign(httpMethod: String, url: String, headers: Map[String, String], payload: String)(implicit config: VideoStreamGeneratorConfig): String = {
	...
	def generateToken(httpMethod: String, url: String, headers: Map[String, String], payload: String)(implicit config: VideoStreamGeneratorConfig): String = {
	...
	def getCanonicalUri(url: String)(implicit config: VideoStreamGeneratorConfig): String = {
